                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="order.php"><span class="fa-copy active">Order</span></a>
                                    </li>
                                    <li>
                    ...
                    <div class="row margin-vert-30">
                        <div class="col-md-12">
                            <div class="error-404-page text-center">
                                <h2>Error!</h2>
                                <h3>Unable to connect to the database</h3>
                                <p>Please check your internet connection and try again.
                                    <br>If the problem persists, contact us on the numbers below.</p>
                            </div>
                        </div>
                    </div>
                </div>
