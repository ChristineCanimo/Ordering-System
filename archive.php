...
$sql = "SELECT customer_no, name, phone_no, address FROM archive";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		...
		$info['Name'] = $row["name"];
		$info['Phone Number'] = $row["name"];
		$info['Address'] = $row["name"];
...
<tr class="w3-yellow">
  ...
  th><font class = "fontsize3">Phone Number</font></th>
  th><font class = "fontsize3">Address</font></th>
