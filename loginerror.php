            ...
            <div id="content">
                <div class="container background-white">
                    <div class="container">
						...
						<blockquote>
                            <p>
                                <em>The username / password you have entered is incorrect.</em>
                            </p>
                        </blockquote>
                            <!-- Login Box -->
                            <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                                <form method= "post" action = "login2.php" class= "login-page">
                                    ...
                                    <div class="input-group margin-bottom-20">
                                        ...
                                        <input placeholder="Username" name = "username" id= "user" class="form-control" type="text">
                                    </div>
                                    <div class="input-group margin-bottom-20">
                                        <span class="input-group-addon">
                                            <i class="fa fa-lock"></i>
                                        </span>
                                        <input placeholder="Password" name = "password" id = "pass" class="form-control" type="password">
                                    </div>
                                    <div class="row">
                                        <div class="col-md-11">
