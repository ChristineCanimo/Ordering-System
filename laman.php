...
$sql = "SELECT * from order2 where customer_no = '$index'";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		...
		$e = $row["zip_code"];
		$f = $row["email_address"];
		$g = $row["event_location"];
		$h = $row["event_date"];
		$i = $row["set_up_date"];
		$j = $row["event_start_time"];
		$k = $row["event_end_time"];
		$l = $row["event_load_time"];
		$m = $row["event_theme"];
		$n = $row["no_guest"];
		$o = $row["description"];
                        ...
                        <div class="row margin-vert-30">
							<!-- Primary Panel -->
                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body" method="post" action="connectarchive.php">
										<table >
											<tr>
											    <td>Customer No.:</td>
												<td><?php echo $a;?></td>
