                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        <span class="fa-gears active">Services</span>
                                        <ul>
                                            <li>
			...
			<div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-40">
                        <div class="col-md-12">
                            <h2 class="margin-bottom-30">Amenities</h2>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapse2-One" class="accordion-body collapse in">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <img src="assets/img/portfolio/34.jpg" alt="filler image">
                                                </div>
                                                <div class="col-md-7">
                                                    Roll Up Chafing Dish<br>
													Buffet Set-up with Center Piece<br>
													Dressed Table for Gifts and Cakes<br>
													Adult Guest Table with Floor Length Tablecloth with Center Piece<br>
													Chairs with Seat Cover and Ribbon Motif<br>
													Kiddie Sets of Tables and Chairs<br>
													Complete Set of Dinnerware, Glassware, and Flatware<br>
													Purified Drinking Water and Iced Tea for Drinks<br>
													Professional and Uniformed Waiters and Staff<br>
													3ft by 3ft Tarpaulin<br>
													Ballon Table Center Piece<br>
												</div>
                                            </div>
                                        </div>
                                    </div>
								...
								<div class="panel panel-default">
                                    ...
                                    <div id="collapse2-Two" class="accordion-body collapse">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <img src="assets/img/portfolio/45.jpg" alt="filler image">
                                                </div>
                                                <div class="col-md-7">
                                                    Elegant Buffet Table Set-up with Center Piece Decor<br>
													Elegant Presidential and Table Set-up<br>
													Elegant Debutant Chair and Backdrop<br>
													Complete Set of Dinnerware, Glassware, and Flatware<br>
													Professional and Uniformed Waiters and Staff<br>
													Bar Table with Skirting<br>
													Decorated Gifts and Cake Table<br>
													Decorated Guest Table with Floor Length Tablecloth with Elegant Center Piece<br>
													Chairs with Seat Cover and Ribbon Trimming<br>
													Purified Drinking Water and Iced Tea for Drinks<br>
													Banquet Coordinator<br>
													18 Pieces of Wine Toast<br>
													18 Pieces of Candles<br>
													3ft by 3ft Tarpaulin<br>
												</div>
                                            </div>
                                        </div>
								...
								<div class="panel panel-default">
                                    ...
                                    <div id="collapse2-Three" class="accordion-body collapse">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <img src="assets/img/portfolio/53.jpg" alt="filler image">
                                                </div>
                                                <div class="col-md-7">
                                                    Roll Up Chafing Dish<br>
													Elegant Buffet Set-up with Center Piece<br>
													Elegant Presidential Table<br>
													Russian Service will be Given to the Presidential Area<br>
													Couples Table and Elegant Chair with Floral Decor<br>
													Professional Uniformed Waiters and Staff<br>
													Decorated Gift Table<br>
													Decorated Cake Table<br>
													Decorated Dove Cage<br>
													A Pair of Dove<br>
													Use of Silverware, Glassware, and Flatware<br>
													Dressed Bar Table<br>
