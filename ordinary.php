			...
			<div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-40">
                        <div class="col-md-12">
                            <h2 class="margin-bottom-30">Ordinary Occassions</h2>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapse2-One" class="accordion-body collapse in">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <img src="assets/img/fillers/asdfghjkl.jpg" alt="filler image">
                                                </div>
                                                <div class="col-md-7">
                                                    <p><h3>12,000 PHP - SERVICE PRICE FOR ORDINARY OCCASSIONS</h3>
														With tables and chairs with cloth and colored motiff<br>
														With buffet table and elegant center piece<br>
														With complete catereing equipments<br>
														With uniformed waiters and buffet staff<br><br></p>
													<p>ADDITIONAL CHARGE FOR TENT:<br>
														SIZE - 12 FT x 24 FT is 1000 PHP<br>
														SIZE - 12 FT x 12 FT is 500 PHP</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
								...
								<div class="panel panel-default">
                                    ...
                                    <div id="collapse2-Two" class="accordion-body collapse">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <img src="assets/img/portfolio/15.jpg" alt="filler image">
                                                </div>
                                                <div class="col-md-7">
                                                    <p><h3>25,000 PHP - SERVICE PRICE FOR ORDINARY OCCASSIONS</h3>
														With tables and chairs with cloth and colored motiff<br>
														With buffet table and elegant center piece<br>
														With complete catereing equipments<br>
														With uniformed waiters and buffet staff<br><br></p>
								...
								<div class="panel panel-default">
                                    ...
                                    <div id="collapse2-Three" class="accordion-body collapse">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <img src="assets/img/portfolio/16.jpg" alt="filler image">
                                                </div>
                                                <div class="col-md-7">
                                                    <p><h3>32,000 PHP - SERVICE PRICE FOR ORDINARY OCCASSIONS</h3>
														With tables and chairs with cloth and colored motiff<br>
														With buffet table and elegant center piece<br>
														With complete catereing equipments<br>
														With uniformed waiters and buffet staff<br><br></p>
