			...
			<div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-40">
                        <div class="col-md-12">
                            <h2 class="margin-bottom-30">Menu Packages - 450 PHP/pax</h2>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapse2-One" class="accordion-body collapse in">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <img src="assets/img/portfolio/11.jpg" alt="filler image">
                                                </div>
                                                <div class="col-md-7">
													Beef Stroganoff<br>
													Polynesian Ham<br>
													Chicken Cordon Blue<br>
													Fish Fillet with Tartar Sauce<br>
													Chopsuey with Quail Egg<br>
													Baked Macaroni<br>
													Steamed Rice
												</div>
                                            </div>
								...
								<div class="panel panel-default">
                                    ...
                                    <div id="collapse2-Two" class="accordion-body collapse">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <img src="assets/img/portfolio/12.jpg" alt="filler image">
                                                </div>
                                                <div class="col-md-7">
													Stir Fried Beef Noodles<br>
													Pork Pomel<br>
													Chicken Supreme<br>
													Breaded Fish Fillet<br>
													Buttered Vegetables<br>
													Bam-S
													Steamed Rice
                                                </div>
                                            </div>
								...
								<div class="panel panel-default">
                                    ...
                                    <div id="collapse2-Three" class="accordion-body collapse">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <img src="assets/img/portfolio/13.jpg" alt="filler image">
                                                </div>
                                                <div class="col-md-7">
                                                    Stir Fried Beef Noodles<br>
													Roar Stuff Pork Loin<br>
													Oriental Chicken<br>
													Fish Fillet with Tartar Sauce<br>
													Mixed Vegetable<br>
													Fresh Lumpia
