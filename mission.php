                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
									<span class="fa-font active">About Us</span>
                                        <ul>
                                            <li>
            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        <!-- Main Column -->
							<div class="col-md-3">
                                <img class="margin-bottom-20" src="assets/img/111.png" alt="logo">
                            </div>
                        <div class="col-md-7">
                            <div class="blog-post">
                                ...
                                <div class="blog-item">
                                    ...
                                    <div class="blog-post-body row">
                                        <div class="col-md-7">
                                            <p>To deliver good and unique services to our clients.</p>
                                        </div>
                                    </div>
                                </div>
								<br>
                                ...
                                <div class="blog-item">
                                    ...
                                    <div class="blog-post-body row">
                                        <div class="col-md-7">
                                            <p>To achieve our goals on the satisfaction of our clients.</p>
                                        </div>
                                    </div>
                                </div>
                        </div>
